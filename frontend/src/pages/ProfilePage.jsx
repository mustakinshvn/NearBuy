...
const ProfilePage = () => {
  ...
  const totalSpent = orders?.reduce((sum, order) => sum + (parseFloat(order.final_amount) || 0), 0) || 0;
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-slate-900 via-slate-800 to-slate-900 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <AlertMessages error={error} setError={setError} success={success} setSuccess={setSuccess} />
