import { Bell, ShoppingBag, Package, Star, RefreshCw, Trash2, Check } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {notifications.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <h2 className="text-2xl font-semibold text-slate-800 mb-2">No Notifications</h2>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-slate-800 font-semibold mb-1">{notification.title}</h3>
